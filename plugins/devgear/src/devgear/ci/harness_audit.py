...
def get_repo_checks(root_dir: str | Path) -> list[dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "points": 4,
            "scopes": ["repo", "skills"],
            "path": "commands/c-stocktake.md",
            "description": "品質監査コマンドが存在する（スキル・コマンド品質監査）",
            "pass": file_exists(root_dir, "commands/c-stocktake.md"),
            "fix": "Add commands/c-stocktake.md for quality audit evaluation.",
        },
        {
            "id": "eval-commands",
            "category": "Eval Coverage",
